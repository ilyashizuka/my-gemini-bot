...
async def get_formatted_text(topic_key):
    """Сборка текста: Шаблон из файла + ВСЕ цены из таблицы parsed_content"""
    kb = load_knowledge()
    ...
    # КАРТА: URL из парсера -> Тег в knowledge.txt
    mapping = {
        ...
        async with conn.cursor() as cur:
            ...
            for row in rows:
                ...
                if url in mapping:
                    ...
                    prices_dict[mapping[url]] = clean_price
